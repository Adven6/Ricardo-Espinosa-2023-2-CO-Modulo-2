...
# El blit sirve para agregar una imagen, 
# desdes de agregarla se les pone unas cordenadas en el plano del juego
    ...
    def Show_menu(self):
        ...
        self.screen.blit(ICON, (half_screeen_width, half_screeen_height - 140))
